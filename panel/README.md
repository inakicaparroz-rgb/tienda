...
- ✅ Stock: buscador con botones **Filtrar ▾** (por ahora "En stock (≥1 unidad)"; Marca y Categoría quedan como próximamente, sin datos cargados todavía) y **Ordenar ▾** (Fecha ingreso menor↔mayor, Alfabético A-Z / Z-A). El botón "Importar stock (CSV)" se sacó de la vista (todas las cargas nuevas son manuales); el código y el modal quedan intactos y el botón se puede reactivar fácilmente si hace falta a futuro.
- ✅ Login con botón para mostrar/ocultar la contraseña.
- ✅ Contador "Mostrando X/Y" en Stock y Ventas, y botón de orden por fecha (asc/desc) en Ventas, para poder corroborar cantidades después de una carga masiva.
